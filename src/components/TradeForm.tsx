...
export function TradeForm({
  ...
  return (
    <form ref={formRef} onSubmit={onSubmit} className="space-y-5">
      ...
      {/* 2 — Taper or monkey */}
      <Card>
        <SectionTitle hint="Did you trade at a taper — the edge, the excess — or were you a monkey trading in the middle of balance?">
          Taper or Monkey?
        </SectionTitle>
      ...
      {/* 5 — Evidence */}
      <Card>
        <SectionTitle hint="Drop in your delta chart, footprint, DOM — tag each one. Paste the YouTube link once your recap video is up.">
          Evidence
        </SectionTitle>
